      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition duration-500 transform hover:scale-105 border border-gray-200 hover:border-indigo-500 relative overflow-hidden cursor-pointer">
        ...
        <div className="flex flex-wrap gap-2 justify-center mt-3">
          {product.tags.map((tags:string) => (
            <span
              key={tags}
              className=" from-indigo-400 to-purple-500 text-slate-800 px-3 py-1 text-xs font-semibold rounded-full shadow-md hover:scale-110 transition"
            >
              #{tags}
            </span>
          ))}
        ...
        <div className="mt-6 text-center">
          <button
            ...
            className="bg-zinc-400 text-white px-4 py-2 rounded-md font-bold hover:bg-zinc-700 transition"
          >
            Add to Wishlist
          </button>
        </div>
        ...
        <div className="mt-3 text-center">
          <button
            ...
            className="bg-black text-white px-4 py-2 rounded-md font-bold hover:bg-gray-600 transition"
          >
            Add to Compare
          </button>
        </div>
